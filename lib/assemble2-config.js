...
config.mongodb.dbpath = "/Users/fjossinet/assemble2-db"
...
config.mongodb.ark.pdb = {'assemble2':true, 'non-redundant-set':true}; //the 'assemble2' key indicates if the junctions have to be stored in a dedicated MongoDB collection
